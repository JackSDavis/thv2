    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='http://t.me/m_mahdihajizadeh'>CLICK HERE FOR SUPPORT </a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
...
<b>Dont Spam.</b>""",
            parse_mode="HTML",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Programmer', url=f"https://t.me/m_mahdihajizadeh"),
                                                                                       InlineKeyboardButton('Instagram', url='https://instagram.com/m.mahdihajizadeh') ] ]  ) )
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [ADARSH GOEL](https://t.me/m_mahdihajizadeh).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
"""
        ...
        await m.reply_text(
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🖥SEE", url=stream_link), #Stream Link
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ ADARSH GOEL](https://t.me/m_mahdihajizadeh).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    ...
    await message.reply_text(
       text="Send me any file/media from telegram, I'll provide external direct download link..",
          ...
          reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("😇Donate", url="https://t.me/m_mahdihajizadeh")]
            ]
        )
    )
